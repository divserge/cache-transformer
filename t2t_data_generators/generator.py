...
_INPUT_FILES = [
    [
        '/workspace/MT/shad_nlp18_contextNMT/data_fused/en_test.src',
        ('en_test.src',)
    ],
    [
        '/workspace/MT/shad_nlp18_contextNMT/data_fused/en_dev.src',
        ('en_dev.src',)
    ],
    [
        '/workspace/MT/shad_nlp18_contextNMT/data_fused/en_train.src',
        ('en_train.src',)
    ]
]
...
_OUTPUT_FILES = [
    [
        '/workspace/MT/shad_nlp18_contextNMT/data_fused/ru_test.dst',
        ('ru_test.dst',)
    ],
    [
        '/workspace/MT/shad_nlp18_contextNMT/data_fused/ru_dev.dst',
        ('ru_dev.dst',)
    ],
    [
        '/workspace/MT/shad_nlp18_contextNMT/data_fused/ru_train.dst',
        ('ru_train.dst',)
    ]
]
